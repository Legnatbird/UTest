...
public class RegisterPage1 extends PageObject {
    ...
    public static final Target Input = Target.the("Input").located(By.xpath("//input[@type='search']"));
    public static final Target NextStep = Target.the("Language Label").located(By.xpath("//a[@class='btn btn-blue']"));
}
